                    ...
                    <div className="col-lg-9  px-4">
                      ...
                      <p className="border-top additional">
                        ...
                        <div className="col-md-2 border-left text-center more-offers">
                          ...
                          <Link className="roo" to="/Roombook">
                            <div className="bttn btn-success">
                              View deal &gt;
                            </div>
                          </Link>
                        </div>
                      ...
                      <div className="row search-card-result">
                        <div className="col-md-3">
                          <div className="inner">
                            <img className="img-fluid" src={img1} alt="card" />
                          </div>
                        </div>
                        <div style={{ marginTop: "1%" }} className="col-md-7">
                          <h5>Choose The Best Plan For You</h5>
                      ...
                      <div className="row search-card-result">
                        <div className="col-md-3">
                          <div className="inner">
                            <img className="img-fluid" src={img2} alt="card" />
                          </div>
                        </div>
                        <div style={{ marginTop: "1%" }} className="col-md-7">
                          <h5>Choose The Best Plan For You</h5>
                      ...
                      <div className="row search-card-result">
                        <div className="col-md-3">
                          <div className="inner">
                            <img className="img-fluid" src={img3} alt="card" />
                          </div>
                        </div>
                        <div style={{ marginTop: "1%" }} className="col-md-7">
                          <h5>Choose The Best Plan For You</h5>
                      ...
                      <p className="border-top additional">
                        ...
                        <div className="col-md-2 border-left text-center more-offers">
                          <h4>
                            <span className="badgee badge-success">
                              Top Deal
                            </span>
                          </h4>
                          <div className="text-warning">
                      ...
                      <div className="row search-card-result">
                        <div className="col-md-3">
                          <div className="inner">
                            <img className="img-fluid" src={img4} alt="card" />
                          </div>
                        </div>
                        <div style={{ marginTop: "1%" }} className="col-md-7">
                          <h5>Choose The Best Plan For You</h5>
                      ...
                      <div className="row search-card-result">
                        <div className="col-md-3">
                          <div className="inner">
                            <img className="img-fluid" src={img5} alt="card" />
                          </div>
                        </div>
                        <div style={{ marginTop: "1%" }} className="col-md-7">
                          <h5>Choose The Best Plan For You</h5>
